...
[./production_vertical]
    ...
    roughness = 
    gravity = '0 0 -9.8'
    block = '0_2000_p 2000_3500_p 3500_4500_p'
    #outputs = exodus
  [../]
  [./production_vertical_lat]
    type = MoskitoLatHeat_Inc_Formation_1p
    temperature_inner = T
    outer_diameters = ' 0.2332 0.2632'
...
[Variables]
  ...
  [./p]
    [./InitialCondition]
      type = FunctionIC
      function = '4000000 -10000 * z'
      variable = p
    [../]
  [../]
  [./q]
    initial_condition = 0.026
  [../]
[]
