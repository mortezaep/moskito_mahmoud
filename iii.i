...
[Functions]
  ...
  [./grad_func]
    type = ParsedFunction
    expression ='283.15 - (z-5000) * 0.03'
  [../]
  [./conductivity_gradient]
    type = ParsedFunction
    expression ='1.5 - (z-5000) * 0.00075'
  [../]
  [./csv_data]
...
[Variables]
  ...
  [./p]
    [./InitialCondition]
      type = FunctionIC
      function = '21000000 -10000 * (z-5000)'
      variable = p
    [../]
  [../]
  [./q]
...
[MultiApps]
  [./coupled]
    ...
    input_files = /Users/morteza/Documents/projects/moskito2/pf.i
