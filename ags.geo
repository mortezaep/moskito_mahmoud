...
Point(2) = {distance/2, 0, -2000, ms};
Point(3) = {500, 250, -3500, ms};
Point(4) = {950, 600, -4400, ms};
...
Point(12) = {-950, 600, -4400, ms};
Point(13) = {-500, 250, -3500, ms};
Point(14) = {-distance/2, 0, -2000, ms};
