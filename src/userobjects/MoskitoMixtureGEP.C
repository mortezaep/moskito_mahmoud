...
#include "MoskitoMixtureGEP.h"

registerMooseObject("MoskitoApp", MoskitoMixtureGEP);

InputParameters
MoskitoMixtureGEP::validParams()
{
...
MoskitoMixtureGEP::MoskitoMixtureGEP(const InputParameters & parameters)
  : MoskitoEOS2P(parameters)
{
}

void
MoskitoMixtureGEP::VMFrac_T_from_p_h(
...
void
MoskitoMixtureGEP::rho_g_from_p_T(
...
void
MoskitoMixtureGEP::rho_l_from_p_T(
  const Real &  press, const Real &  temp, Real & rho, Real & drho_dp, Real & drho_dT, const Real & phase) const
{
  rho = 1000.0;
  drho_dp = 0.000001;
...
Real
MoskitoMixtureGEP::rho_g_from_p_T(const Real & press, const Real & temp, const Real & phase) const
{
  Real rho = 1.0;
...
Real
MoskitoMixtureGEP::rho_l_from_p_T(const Real &  press, const Real &  temp, const Real & phase) const
{
  Real rho = 1000.0;
...
Real
MoskitoMixtureGEP::cp_m_from_p_T(
...
Real
MoskitoMixtureGEP::rho_m_from_p_h(const Real & press, const Real & enthalpy) const
{
...
void
MoskitoMixtureGEP::h_lat(const Real & press, Real & hlat, Real & hsatl, Real & hsatg) const
{
...
void
MoskitoMixtureGEP::PENG_PURE(const Real & press, const Real & temp, Real tc[], Real pc[], Real m[], Real a[], Real b[]) const
{
  int i;
...
void
MoskitoMixtureGEP::PENG_MIX(const Real & press, const Real & temp, Real y[], const Real a[], const Real b[],
...
void
MoskitoMixtureGEP::ROOT_FINDER(const Real & capital_a, const Real & capital_b, Real & z) const
{
...
void
MoskitoMixtureGEP::CONCENTRATION_CALCULATOR(const Real k[], const Real tmf[], Real & non_aqueous_mf, Real x[], Real y[]) const
{
...
void
MoskitoMixtureGEP::FRAC_CONVERTER(const Real omf[], const Real tmf[], const Real & non_aqueous_mf, const Real x[],
...
void
MoskitoMixtureGEP::ACTIVITY(const Real & press, const Real & t, const Real x[],
...
void
MoskitoMixtureGEP::HENRY(const Real & press, const Real & temp, Real hen[]) const
{
...
void
MoskitoMixtureGEP::FUG(const Real & capital_a, const Real & capital_b, const Real & z, const Real y[], const Real b[],
...
void
MoskitoMixtureGEP::K_CONVERGENCE(const Real & press, const Real & temp, const Real hen[], const Real gama[],
...
void
MoskitoMixtureGEP::TH_DRIESNER(const Real & press, const Real & temp, const Real s_molef[], const Real molef[], Real & th) const
{
...
Real
MoskitoMixtureGEP::SATURATED_H_WATER(const Real & th) const
{
...
Real
MoskitoMixtureGEP::SPECIFIC_V_WATER(const Real & press, const Real & th) const
{
...
Real
MoskitoMixtureGEP::T_EXPANSION_WATER(const Real & th) const
{
...
Real
MoskitoMixtureGEP::P_SAT_WATER(const Real & th) const
{
...
void
MoskitoMixtureGEP::SALT_ENTHALPY(const Real & temp, const Real s_molality[], Real sh[]) const
{
  int i,j;
...
void
MoskitoMixtureGEP::LIQUID_ENTHALPY(const Real s_massf[], const Real massf[], const Real sh[],
...
void
MoskitoMixtureGEP::GAS_H(const Real & t, const Real y[], const Real & z, const Real & sum_a, const Real & sum_b,
...
void
MoskitoMixtureGEP::GAS_RO(const Real & p, const Real & t, const Real & z, const Real y[],
...
void
MoskitoMixtureGEP::TV_DRIESNER(const Real & press, const Real & temp, const Real tmf[], Real & tv) const
{
...
void
MoskitoMixtureGEP::LIQUID_RHO(const Real & p, const Real & t, Real & l_rho, const Real s_molality[],
...
/*
void
MoskitoMixtureGEP::GAS_VIS(const Real & press, const Real & temp, const Real tc[], const Real pc[],
...
*/
void
MoskitoMixtureGEP::LIQUID_VIS(const Real & t, const Real s_massf[], const Real massf[], Real & l_vis) const
{
  int i;
...
void
MoskitoMixtureGEP::VAR_SEQUENCE(const Real & var, vector<Real> & var_seq) const
{
...
void
MoskitoMixtureGEP::VAR_GRADIENT(const Real & press, const Real & temp, const Real tmf[],
...
void
MoskitoMixtureGEP::Transport_PROP(const Real & g_ro, const Real & l_ro, const Real & non_aqueous_mf,
...
//void
//MoskitoMixtureGEP::INITIALIZER(const Real & pressure, const Real & temperature, Real & press, Real & temp, const Real omf[], Real tmf[], Real m_mass[], Real k[]) const
//{
...
void
MoskitoMixtureGEP::mix_PROP(const Real x[], const Real y[], const Real & non_aqueous_mf,
...
void
MoskitoMixtureGEP::Itera(const Real & h, const Real & p, const Real & m,const Real c_vect[], Real & g_ro, Real & l_rho,
    ...
    Real aux1_arr[], Real aux2_arr[], Real & viscosity, Real & conductivity) const
{
  ...
  Real roh2o, hh2o, rov, rol, usv, usl, xv, enthalpy, con[5], g_con, l_con, ct, newk2, newk3, newk4, newk5;
...
for(it=1; it<=3; it++)
{
  ...
  K2(p, t-273.15, omf, newk2);
  K3(p, t-273.15, omf, newk3);
  K4(p, t-273.15, omf, newk4);
  K5(p, t-273.15, omf, newk5);
...
///////^^^^^^^^^^^^^^
void
MoskitoMixtureGEP::water_v(const Real y[], const Real & p, const Real & t, Real & roh2o,
...
///////^^^^^^^^^^^^^^
void
MoskitoMixtureGEP::GAS_VIS(const Real & p, const Real & t, const Real tc[], const Real pc[],
...
///////^^^^^^^^^^^^^^
void
MoskitoMixtureGEP::GAS_IN_LIQ(const Real & t, const Real & p, Real gas_ha[], Real ro[]) const
{
...
///////^^^^^^^^^^^^^^
void
MoskitoMixtureGEP::CONDUCTIVITY_GAS(const Real & t, const Real & p, Real & g_con, const Real & g_vis,
...
void
MoskitoMixtureGEP::GAS_MV(const Real & t, const Real & p, Real molarv[]) const
{
...
void
MoskitoMixtureGEP::GAS_MV_DERIV(const Real & t, const Real & p, Real molarv_deriv[]) const
{
...
void
MoskitoMixtureGEP::GAS_LD(const Real & t, Real molarv_vol[]) const
{
...
void
MoskitoMixtureGEP::enti(const Real & non_aqueous_massf, const Real &  gas_prop, const Real &  liq_prop, Real & ent) const
{
...
void
MoskitoMixtureGEP::LIQ_CONDUCTIVITY(const Real & t, Real & l_con, const Real s_massf[], const Real massf[]) const
{
...
void
MoskitoMixtureGEP::TEMPE(const Real & p, const Real & h, const Real omf[], Real & ct) const
{
...
void
MoskitoMixtureGEP::K2(const Real & p, const Real & newt, const Real omf[], Real & newk) const
{
  double y, d[13];
...
void
MoskitoMixtureGEP::K3(const Real & p, const Real & newt, const Real omf[], Real & newk) const
{
  double y, d[13];
...
void
MoskitoMixtureGEP::K4(const Real & p, const Real & newt, const Real omf[], Real & newk) const
{
  double y, d[13];
...
void
MoskitoMixtureGEP::K5(const Real & p, const Real & newt, const Real omf[], Real & newk) const
{
  double y, d[13];
