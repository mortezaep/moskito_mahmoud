...
#ifndef MOSKITOMIXTUREGEP_H
#define MOSKITOMIXTUREGEP_H
...
class MoskitoMixtureGEP : public MoskitoEOS2P
{
public:
  static InputParameters validParams();

  MoskitoMixtureGEP(const InputParameters & parameters);
